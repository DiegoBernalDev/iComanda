...
El proyecto se organizó en \textbf{3 sprints de 2 semanas} cada uno:
...
\begin{longtable}{>{\bfseries}p{1.5cm} p{11.5cm}}
  ...
  1 & Configuración del proyecto Expo, conexión con Supabase, diseño inicial
      del esquema de base de datos, autenticación, roles, RLS y estructura base
      de rutas para administrador y mesero. \\[4pt]

  2 & Gestión administrativa del restaurante, usuarios, mesas, menú, registro
      de pedidos, flujo de estados de orden, pagos, gastos y vista de mesas en
      tiempo real mediante Supabase Realtime. \\[4pt]

  3 & Carta digital pública por QR, sesión de cliente en mesa, llamada al mesero,
      rol chef/cocina, control de platos agotados, inventario de materiales,
      reportes financieros, ranking de platos y pruebas finales. \\
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item \textbf{GitHub:} Control de versiones distribuido y respaldo del repositorio.
        Se utilizaron ramas auxiliares para desarrollo personal, integradas luego
        a la rama principal y eliminadas después del merge.

...
\subsection*{Sprint 3 — Tiempo real, carta digital, cocina, inventario y reportes}

\textbf{Objetivo:}
Carta digital pública, sesión de cliente en mesa, rol chef, inventario, reportes y cierre funcional.
...
\item \textbf{Vista pública de cliente en mesa (web)}

\begin{itemize}
\item HU-45: Abrir vista pública al escanear el QR de la mesa
...
\item \textbf{Cocina y disponibilidad operativa}

\begin{itemize}
\item HU-52: Implementar rol chef/cocina
\item HU-53: Panel de pedidos para cocina
\item HU-54: Marcar pedido como listo desde cocina
\item HU-55: Marcar plato como agotado o disponible desde cocina
\end{itemize}

\item \textbf{Inventario y control de materiales}

\begin{itemize}
\item HU-56: Crear módulo de inventario de materiales
\item HU-57: Registrar reposiciones y consumos de inventario
\item HU-58: Visualizar materiales con stock bajo
\end{itemize}

\item \textbf{Reportes y cierre operativo}

\begin{itemize}
\item HU-59: Reporte de ventas por mesero
\item HU-60: Liberar mesa después de pago confirmado
\item HU-61: Generar comprobante de orden entregada
\item HU-62: Registrar fecha efectiva de pago con \texttt{paid\_at}
\item HU-63: Generar snapshot server-side del estado de mesas
\end{itemize}
...
\bigskip
\begin{center}
\textit{63 historias de usuario · 3 sprints · 6 semanas}
\end{center}
...
(\texttt{iComanda}). Este enfoque centralizado permite una
...
\begin{itemize}[leftmargin=1.5em]
  \item \textbf{\texttt{main}:} rama principal del proyecto, utilizada para consolidar los avances estables.
  \item \textbf{Ramas auxiliares:} ramas temporales para desarrollo personal o pruebas de módulos, integradas posteriormente a \texttt{main} y eliminadas después del merge.
\end{itemize}

\begin{notabox}
Para evidenciar el control de versiones en la entrega final, se recomienda incluir
una captura del repositorio en GitHub mostrando el historial de commits o la vista
general del repositorio, además de un QR que redirija al repositorio. Nombres usados:
\texttt{repositorio-captura.png} y \texttt{qr-repo.png}. URL del repositorio:
\url{https://github.com/DiegoBernalDev/iComanda.git}.
\end{notabox}
...
\begin{longtable}{>{\bfseries}p{2cm} p{9cm} c}
  ...
  HU-45 & Abrir vista pública al escanear el QR de la mesa & \checkmark \\
  ...
  HU-52 & Implementar rol chef/cocina & \checkmark \\
  HU-53 & Panel de pedidos para cocina & \checkmark \\
  HU-54 & Marcar pedido como listo desde cocina & \checkmark \\
  HU-55 & Marcar plato como agotado o disponible desde cocina & \checkmark \\
  HU-56 & Crear módulo de inventario de materiales & \checkmark \\
  HU-57 & Registrar reposiciones y consumos de inventario & \checkmark \\
  HU-58 & Visualizar materiales con stock bajo & \checkmark \\
  HU-59 & Reporte de ventas por mesero & \checkmark \\
  HU-60 & Liberar mesa después de pago confirmado & \checkmark \\
  HU-61 & Generar comprobante de orden entregada & \checkmark \\
  HU-62 & Registrar fecha efectiva de pago con \texttt{paid\_at} & \checkmark \\
  HU-63 & Generar snapshot server-side del estado de mesas & \checkmark \\
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item \textbf{GitHub:} control de versiones, respaldo del repositorio y seguimiento del historial de commits.
